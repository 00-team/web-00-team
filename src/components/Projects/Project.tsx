...
// import getProject from '../../redux/actions/data/loadProjects'
// import { ProjectsModel } from 'src/redux/models/Projects'
...
const Project = () => {
    ...
    // const ProjectState = useSelector<ProjectsModel>(state => state.projects)
    // console.log(props)
