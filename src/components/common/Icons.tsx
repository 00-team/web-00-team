import React, { Component, ReactElement, ReactNode, CSSProperties } from 'react'
...
class Icon extends Component<IconProps> {
    private size = this.props.size || 24
...
export class FilmProjector extends Component<IconProps> {
    override render() {
        return (
            <Icon {...this.props} viewBox='0 0 512 512'>
...
export class HandShake extends Component<IconProps> {
    override render() {
        return (
            <Icon {...this.props} viewBox='0 0 640 512'>
...
export class QuestionMark extends Component<IconProps> {
    override render() {
        return (
            <Icon {...this.props} viewBox='0 0 16 16'>
...
export class TeamIdea extends Component<IconProps> {
    override render() {
        return (
            <Icon {...this.props} viewBox='0 0 512 512'>
